...
- Alias version brought back into lock-step with `tibet-ai-sbom`.
- Dependency pinned exactly to `tibet-ai-sbom==0.2.3`.
- No independent implementation: `ai-sbom` remains a CLI/import alias.
